...
class crcStandardParameters
{
  static  Map<crcAlgorithms, crcParameters> StandardParams =
  {
    //crcAlgorithms.Crc8:crcParameters(Name:"CRC-8",Check:BigInt.from(8) , Init:BigInt.parse("0x7") , Poly:BigInt.parse("0x0") , RefIn:false, RefOut:false, XorOut:BigInt.parse("0x0") , HashSize:BigInt.parse("0xF4")),
    //crcAlgorithms.Crc8Cdma2000:new crcParameters(Name:"CRC-8/CDMA2000", Check:BigInt.from(8), Init:BigInt.parse("0x9B"), Poly:BigInt.parse("0xFF"), RefIn:false, RefOut:false, XorOut:BigInt.parse("0x0"), HashSize:BigInt.parse("0xDA")),
    crcAlgorithms.Crc16CcittFalse:new crcParameters(Name:"CRC-16/CCITT-FALSE", Check:BigInt.from(16), Init:BigInt.parse("0xFFFF"), Poly:BigInt.parse("0x1021") , RefIn:false, RefOut:false, XorOut:BigInt.parse("0x0"), HashSize:16)
  };
